"""
Генератор тестовых данных для варианта 5: Анализ отделов
Создает три файла:
...
def generate_sales_data(branches_data):
    """Генерация данных о продажах (Excel)"""
...
def main():
    ...
    print("Создание branch.csv ")
    branch_data = generate_branch_data(1000)  
    
    print("Создание sales.xlsx ")
    sales_data = generate_sales_data(branch_data)  
    
    print("Создание sales_plan.json ")
